...
return [
    ...
    'intro_text' => <<<INTRO
        Essa documentação tem como objetivo fornecer todas as informações necessárias para trabalhar a API do carrinho de compras.
        ...
        de implementação em PHP e JavaScript.
